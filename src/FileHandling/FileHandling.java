...
public class FileHandling {
    public static StoreNE getJsonToObj(String json_file) {
        ...
        try {
            ...
            List<NodeC> nodes = new ArrayList<>();
            ...
            HashMap<Integer, NodeC> hp_nodes = convertNodesList(nodes);
    ...
    public static HashMap<Integer, NodeC> convertNodesList(List<NodeC> list) {
        HashMap<Integer, NodeC> map = new HashMap<>();
        for (NodeC node : list) {
