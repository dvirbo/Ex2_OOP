 ...
 * 5. NodeData center(); // finds the NodeData which minimizes the max distance
 * to all the other nodes.
 * // Assuming the graph isConnected, elese return null. See:
 * https://en.wikipedia.org/wiki/Graph_center
 * 6. List<NodeData> tsp(List<NodeData> cities); // computes a list of
 * consecutive nodes which go over all the nodes in cities.
...
public interface DirectedWeightedGraphAlgorithms {
    ...
    /**
     * Computes the the shortest path between src to dest - as an ordered List of
     * nodes:
     * src--> n1-->n2-->...dest
     ...
     * Assuming the graph isConnected, else return null. See:
     * https://en.wikipedia.org/wiki/Graph_center
     * 
