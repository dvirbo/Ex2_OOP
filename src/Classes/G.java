...
public class G implements DirectedWeightedGraph {
    ...
    // String = src_Valuesrc_dest_Valuedest
    ...
    public G(HashMap<Integer, NodeC> nodes, HashMap<String, EdgeData> edges) {
        this.nodes = nodes;
        this.edges = edges;
        this.modeCount = 0;
    }
    ...
    public NodeData removeNode(int NodeId) {
        if (this.nodes.containsKey(NodeId)) {
            NodeData n = new NodeC(this.nodes.get(NodeId));
