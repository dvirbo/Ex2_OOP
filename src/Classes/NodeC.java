...
public class NodeC implements NodeData {
    ...
    public NodeC(int uniqueKey, CGeo g, int weight, String info, int tag) {
        this.key = uniqueKey;
    ...
    public NodeC(String pos, String id) {
